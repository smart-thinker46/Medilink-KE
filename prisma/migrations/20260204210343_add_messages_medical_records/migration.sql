/*
  ...
  - You are about to drop the column `chiefComplaint` on the `medical_records` table. All the data in the column will be lost.
  - You are about to drop the column `date` on the `medical_records` table. All the data in the column will be lost.
  - You are about to drop the column `diagnosis` on the `medical_records` table. All the data in the column will be lost.
  - You are about to drop the column `treatmentPlan` on the `medical_records` table. All the data in the column will be lost.
  - You are about to drop the column `visitId` on the `medical_records` table. All the data in the column will be lost.
...
-- DropIndex
DROP INDEX "medical_records_visitId_key";

-- AlterTable
ALTER TABLE "medical_records" DROP COLUMN "chiefComplaint",
DROP COLUMN "date",
...
ALTER COLUMN "medicId" DROP NOT NULL;
...
-- CreateIndex
CREATE INDEX "medical_records_medicId_idx" ON "medical_records"("medicId");
...
-- AddForeignKey
ALTER TABLE "medical_records" ADD CONSTRAINT "medical_records_medicId_fkey" FOREIGN KEY ("medicId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
