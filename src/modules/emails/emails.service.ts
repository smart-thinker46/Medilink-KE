  ...
  t(locale: 'en' | 'sw', key: string) {
    const dict = {
      en: {
        ...
        login_otp_title: 'Your login verification code',
        login_otp_body: 'Use the OTP below to complete your sign in.',
        otp_code_label: 'OTP Code',
        otp_expiry_line: 'This code expires in',
      ...
      sw: {
        ...
        login_otp_title: 'Nambari yako ya uthibitisho wa kuingia',
        login_otp_body: 'Tumia OTP iliyo hapa chini kukamilisha kuingia kwako.',
        otp_code_label: 'Nambari ya OTP',
        otp_expiry_line: 'Muda wa kuisha wa nambari hii ni',
